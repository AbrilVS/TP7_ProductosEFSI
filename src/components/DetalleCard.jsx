...
// import { CarritoContext } from '../context/CarritoContext'; // Ajustá la ruta si es necesario

// function DetalleCard({ product }) {
//   const { addToCart } = useContext(CarritoContext); // Traemos la función del contexto
